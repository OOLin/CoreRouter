...
#[derive(Debug)]
pub struct CoreRouterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CoreRouterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoreRouter processing");
    
    let mut processor = CoreRouterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoreRouterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoreRouterProcessor::new(false);
